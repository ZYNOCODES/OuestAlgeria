document.addEventListener("DOMContentLoaded", function () {
    ...
    const ViaducsData = PontsData.filter(data => (data.Categorie === "Viaduc") || (data.Categorie === "maconnerie"));
    const UpdatedPontsData = PontsData.filter(data => (data.Categorie !== "Viaduc")&& (data.Categorie !== "maconnerie"));
